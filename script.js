...
const iconMarkup = {
  instagram: `
    <svg viewBox="0 0 24 24">
      ...
      <circle cx="17.4" cy="6.7" r="1" class="icon-fill"></circle>
    </svg>`,
  linkedin: `
    <svg viewBox="0 0 24 24">
...
const renderProfile = () => {
  ...
  if (profile.links.length === 0) {
    ...
    emptyMessage.className = "empty-links";
    emptyMessage.textContent = "Novos links serão publicados em breve.";
    linksElement.append(emptyMessage);
  }
};
...
const shareProfile = async () => {
  const shareData = {
    ...
    text: `Acesse os links de ${profile.name}.`,
